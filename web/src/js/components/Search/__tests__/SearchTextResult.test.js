...
describe('SearchTextResult page component', () => {
  it('renders without error', () => {
    const SearchTextResult = require('js/components/Search/SearchTextResult')
      .default
    const mockProps = getMockProps()
    shallow(<SearchTextResult {...mockProps} />)
  })
  ...
  it('displays the title as a clickable link', () => {
    ...
    const wrapper = shallow(<SearchTextResult {...mockProps} />)
