...
const getMockProps = () => ({
  charity: {
    id: 'some-charity-id',
    image:
      'http://static.example.com/img/charities/charity-post-donation-images/acfusa.jpg',
    impact:
      'Your donation helps move us one step closer to ending world hunger.',
...
describe('DonateHeartsControls component', () => {
  it('renders without error', () => {
    ...
    shallow(<DonateHeartsControlsComponent {...mockProps} />).dive()
  })
  ...
  it('shows the correct sanitized HTML content in the post-donation message', () => {
    const DonateHeartsControlsComponent = require('js/components/Donate/DonateHeartsControlsComponent')
      .default
    const mockProps = getMockProps()
    mockProps.charity.impact =
      '<p>Your support is going to some <a data-thing="this attribute is not allowed" href="http://example.com" target="_blank" rel="noopener noreferrer">good stuff</a>.</p><script>var foo = "script tags are not allowed!"</script>'
    const wrapper = shallow(
      <DonateHeartsControlsComponent {...mockProps} />
    ).dive()
    expect(
      ...
      '<p>Your support is going to some <a href="http://example.com" target="_blank" rel="noopener noreferrer">good stuff</a>.</p>'
    )
  })
