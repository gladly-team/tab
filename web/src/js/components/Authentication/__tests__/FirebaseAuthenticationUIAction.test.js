...
describe('FirebaseAuthenticationUIAction tests', function() {
  it('renders without error and does not have any DOM elements', () => {
    const FirebaseAuthenticationUIAction = require('js/components/Authentication/FirebaseAuthenticationUIAction')
      .default
    const wrapper = shallow(<FirebaseAuthenticationUIAction {...mockProps} />)
  ...
  it('calls checkIfEmailVerified on mount', async () => {
    ...
    const FirebaseAuthenticationUIAction = require('js/components/Authentication/FirebaseAuthenticationUIAction')
      .default
    shallow(<FirebaseAuthenticationUIAction {...mockProps} />)
