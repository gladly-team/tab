const data = [
  {
    ...
    dollarAmount: 5e6, // $5
    impactTitle:
      "Provide ${count} home visit${count > 1 ? 's' : ''} from a community health worker",
    metricTitle: "${count} home visit${count > 1 ? 's' : ''}",
    description:
  ...
  },
  {
    ...
    impactTitle:
      "Provide prenatal care for ${count} wom${count > 1 ? 'e' : 'a'}n",
  ...
  },
  {
    ...
    impactTitle: "Provide ${count} infant care package${count > 1 ? 's' : ''}",
    metricTitle: "${count} newborn baby kit${count > 1 ? 's' : ''}",
    description:
  ...
  },
  {
    ...
    impactTitle:
      "Provide ${count} child${count > 1 ? 'ren' : ''} with an emergency nutrition course",
    metricTitle: "${count} malnutrition treatment${count > 1 ? 's' : ''}",
    description:
  ...
  },
  {
    ...
    metricTitle: '${count} chest binders',
    description:
  ...
  },
  {
    ...
    metricTitle: "${count} homes' energy use offset",
    description:
  ...
  },
  {
    ...
    metricTitle: '${count} family survival kits',
    description:
