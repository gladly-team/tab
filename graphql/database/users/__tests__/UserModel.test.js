  ...
  it('constructs as expected', () => {
    ...
    expect(item).toEqual({
      ...
      backgroundImage: {
        ...
        imageURL: `${mediaRoot}/img/backgrounds/3acd54614b1d4d7fbce85d965de3de25.jpg`,
        thumbnailURL: `${mediaRoot}/img/background-thumbnails/71a27d6823244354acb85e0806d0dff1.jpg`,
