...
describe('logUserDataConsent', () => {
  ...
  test('consent-string module decodes consent string as expected', async () => {
    ...
    const consentStr = 'BOOPq4VOOPr7lABABBENAb-AAAAT17______b9_3__7_9uz_Kv_K7Xf_nnW0721PVA_rXOz_gE7YRAEIAkA'
    ...
    expect(userDataConsentCreate.mock.calls[0][1]).toMatchObject(
      addTimestampFieldsToItem({
        ...
        allowedVendorIds: [
          ...
          38, 39, 40, 41, 42, 43, 45, 46, 48, 49, 50, 51, 52, 53, 55, 56, 57,
          58, 59, 60, 61, 62, 63, 65, 66, 67, 68, 69, 70, 71, 72, 73, 74, 75,
          76, 77, 78, 79, 80, 81, 82, 84, 85, 86, 87, 88, 89, 90, 91, 92, 93,
          94, 95, 97, 98, 100, 101, 102, 104, 105, 108, 109, 110, 111, 112, 113,
          114, 115, 118, 120, 122, 124, 125, 126, 127, 128, 129, 130, 131, 132,
          133, 136, 138, 140, 141, 142, 144, 145, 147, 149, 150, 151, 153, 154,
          155, 156, 157, 158, 159, 160, 161, 162, 163, 164, 167, 168, 169, 170,
          173, 174, 175, 177, 179, 180, 182, 183, 185, 188, 189, 190, 192, 193,
          194, 195, 197, 198, 200, 201, 203, 205, 208, 209, 210, 211, 213, 215,
          217, 224, 225, 226, 227, 228, 229, 230, 232, 234, 235, 237, 239, 240,
          241, 244, 245, 246, 248, 249, 252, 253, 254, 255, 256, 257, 258, 259,
          260, 269, 272, 273, 274, 276, 277, 279, 280, 285, 289, 299, 304, 314,
          317
        ],
